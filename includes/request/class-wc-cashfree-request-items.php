...
class WC_Cashfree_Request_Item {
	...
	public static function build( $order, $item ) {
        ...
        return array(
            ...
            'item_original_unit_price'  => self::cfConvertToNumber($product->get_regular_price() ? $product->get_regular_price() : 0),
            'item_discounted_unit_price'=> self::cfConvertToNumber($product->get_price() ? $product->get_price() : 0),
